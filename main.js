    ...
    value: function start() {
      ...
      setInterval(function () {
        if (_this.index || _this.index === 0) {
          _this.cells[_this.index].classList.remove('active');
          _this.cells[_this.index].innerHTML = '';
        }
        _this.getIndex();
        _this.cells[_this.index].classList.add('active');
        _this.cells[_this.index].appendChild(_this.img);
      }, 1000);
    }
  }]);
  return Game;
